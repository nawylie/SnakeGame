...
/**
 * Stores position, speed, length of the Snake sprite
 * 
 * @author Nick Wylie
 * @version 2018.11.10
 */
public class Snake {
	 ...
	 *
	 * @param grid         The grid the Snake will reside in
	 * @param initialPoint The inital point to the put the snake's head on at the
	 *                     start of the game
	 */
	...
	/**
	 * @return The x and y velocity of the Snake
	 */
